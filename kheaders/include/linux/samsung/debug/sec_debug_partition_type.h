...
#define SEC_DEBUG_RESET_ETRM_OFFSET		(SEC_DEBUG_AUTO_COMMENT_OFFSET + ALIGN(SEC_DEBUG_AUTO_COMMENT_SIZE, SECTOR_UNIT_SIZE))	

#define SEC_DEBUG_RESET_LPM_KLOG_OFFSET		(6 * 1024 * 1024)
#define SEC_DEBUG_RESET_LPM_KLOG_SIZE		(0x200000)		
