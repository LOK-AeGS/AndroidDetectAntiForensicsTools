...
struct fiemap_extent_p {
	...
	unsigned long fe_physical; 
	unsigned long fe_length;   
...
#define SEC_PARAM_FILE_SIZE	CONFIG_SEC_PARAM_SIZE  
...
#define SEC_PARAM_QUEST_SIZE				(0x2000) 
#define SEC_PARAM_QUEST_DDR_RESULT_OFFSET	(SEC_PARAM_QUEST_OFFSET + SEC_PARAM_QUEST_SIZE) 
#endif

#ifdef CONFIG_SEC_QUEST_BPS_CLASSIFIER

#define SEC_PARAM_QUEST_DDR_RESULT_SIZE				(0x2000) 
#define SEC_PARAM_QUEST_BPS_DATA_OFFSET	(SEC_PARAM_QUEST_DDR_RESULT_OFFSET + SEC_PARAM_QUEST_DDR_RESULT_SIZE) 
#endif
